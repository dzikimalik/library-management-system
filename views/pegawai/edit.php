...
<div class="card">
    <div class="card-body">
        <form action="<?= BASE_URL ?>pegawai/update/<?= $p['id'] ?>" method="POST">
            <?= csrf_field() ?>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="form-label">Nama <span class="text-danger">*</span></label>
                    <input type="text" name="nama" class="form-control" required value="<?= sanitize($p['nama']) ?>">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">NIP <span class="text-danger">*</span></label>
                    <input type="text" name="nip" class="form-control" required value="<?= sanitize($p['nip']) ?>">
                </div>
                <div class="col-md-6 mb-3">
